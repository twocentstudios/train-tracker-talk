...
struct MillisecondDatePicker: View {
    ...
    init(date: Binding<Date>) {
        self._date = date
        self._baseDate = State(initialValue: date.wrappedValue)
        ...
        self._seconds = State(initialValue: calendar.component(.second, from: date.wrappedValue))
        self._milliseconds = State(initialValue: totalMilliseconds)
    }
